  ...
  <section class="home-section">
    <div class="main_wrapper p-0">
        <div class="d-flex justify-content-between" style="background-color:#4e4c4c;">
            ...
            <a href="video" class="h_tab active"><i class="fa fa-caret-left text-white pr-2" aria-hidden="true"></i> Videos<i class="fa fa-caret-right text-white pl-2" aria-hidden="true"></i></i></a>
...
<!--            <a href="#" class="previous round"><i class="fa fa-caret-left text-white pr-2" aria-hidden="true"></i></a><strong class="text-white">ADD</strong>-->
