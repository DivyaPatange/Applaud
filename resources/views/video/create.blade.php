...
<div class="main_wrapper" id="hey">
    <ul class="nav nav-tabs d-flex flex-wrap" id="myTab" role="tablist">
      ...
      <li class="nav-item">
        <a class="nav-link h_tab active" href="#">Video</a>
      </li>
      <li class="nav-item">
            ...
            <div class="container-fluid">
                <form action="{{route('video.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="input_filds row px-5 mb-3">
                        ...
                        <div class="col-md-2">
                            <input class="@error('videographer') is-invalid @enderror" type="text" placeholder="Videographer" name="videographer">
                            @error('videographer')
                         ...
                         <div class="col-md-2">
                            <input class="@error('date') is-invalid @enderror" type="text" placeholder="Date" name="date">
                            @error('date')
                                <div class="d-flex flex-column invalid-feedback" role="alert">
                                    <strong class="text-white">{{ $message }}</strong>
                                </div>
                         ...
                         <div class="col-md-2">
                             <input class="@error('categocy') is-invalid @enderror" type="text" placeholder="Category" name="category">
                               @error('category')
                                <div class="d-flex flex-column invalid-feedback" role="alert">
                                    <strong class="text-white">{{ $message }}</strong>
                                </div>
                    ...
                    <div class="row mx-2 offset-2">
                        ...
                        <div class="drop-zone col-lg-3 col-md-3 col-sm-12" style="margin:1%;">
                            <span class="drop-zone__prompt">Drag and Drop File</span>
