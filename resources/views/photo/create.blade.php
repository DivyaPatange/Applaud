...
<div class="main_wrapper" id="hey">
    <ul class="nav nav-tabs d-flex flex-wrap" id="myTab" role="tablist">
      ...
      <li class="nav-item">
        <a class="nav-link h_tab active" href="#">Photo</a>
      </li>
      <li class="nav-item">
                   ...
                   @csrf
                    <div class="input_filds row px-5 mb-3">
                        <div class="item col-md-4">
                            ...
                            <label for="html" class="text-white">Free</label>
                            <!-- <input style="width:50px;" class="d-none ml-3" type="text" name="price"> -->
                        </div>
                    ...
                    <div class="input_filds row justify-content-between flex-wrap px-5 mb-3">
                    <div class="item col-md-4">
                        ...
                        <div class="col-md-2">
                            <input type="text" placeholder="Photographer" name="photographer" class="@error('composer') is-invalid @enderror">
                            @error('photographer')
                    ...
                    <div class="drop-zone col-lg-11 col-md-11 col-sm-12 mx-3">
